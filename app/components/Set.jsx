  ...
  return (
    <Component ref={ref} className="px-6 py-4">
      <div className="flex items-center gap-4">
        <div className="text-sm font-bold text-gray-700 dark:text-gray-200 w-6">{index + 1}</div>
        ...
        <button
          ...
          aria-label={
            confirming
              ? `Are you sure you want to remove set ${index + 1}?`
              : `Remove set ${index + 1}`
          }
        >
          <FontAwesomeIcon
            icon={confirming ? faTriangleExclamation : faCircleMinus}
            size="md"
            aria-hidden="true"
          />
        </button>
