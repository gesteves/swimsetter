...
const ButtonBar = forwardRef(function ButtonBar({ onAddSet }, ref) {
  return (
    <div 
      ref={ref} 
      className="fixed bottom-0 left-0 right-0 bg-white/85 dark:bg-gray-800/85 border-t border-gray-200 dark:border-gray-700 shadow-lg px-4 py-4 flex justify-center [@supports(backdrop-filter:none)]:bg-white/75 [@supports(backdrop-filter:none)]:dark:bg-gray-800/75 [@supports(backdrop-filter:none)]:backdrop-blur-[20px]"
    >
      <button
